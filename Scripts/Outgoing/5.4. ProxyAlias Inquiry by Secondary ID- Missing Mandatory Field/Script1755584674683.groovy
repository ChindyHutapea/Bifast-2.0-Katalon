...
RequestObject request = findTestObject('Outgoing/5.4. ProxyAlias Inquiry by Secondary ID- Missing Mandatory Field', variable)
...
CustomKeywords.'mii.validation.compareResponseMessage'(bodyResponse, 'Missing Mandatory Field')
