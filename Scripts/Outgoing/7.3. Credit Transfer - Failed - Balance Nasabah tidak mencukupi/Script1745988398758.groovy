...
RequestObject request = findTestObject('Outgoing/7.3. Credit Transfer - Failed - Balance Nasabah tidak mencukupi', variable)
...
CustomKeywords.'mii.CreditTransfer.compareResponseCode'(bodyResponse, '3243')
