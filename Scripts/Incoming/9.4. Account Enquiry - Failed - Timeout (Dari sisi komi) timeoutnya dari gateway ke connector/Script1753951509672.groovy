...
RequestObject request = findTestObject('Incoming/Postman/9.4. Account Enquiry - Failed - Timeout (Dari sisi komi) timeoutnya dari gateway ke connector', 
    variable)
...
CustomKeywords.'mii.AccountInquiryIncoming.comparePrtry'(actualResponse, 'U804')
