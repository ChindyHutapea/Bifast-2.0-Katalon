...
variable.put('channelRef', channelRef)

RequestObject request = findTestObject('Outgoing/7.5. Credit Transfer - Failed - Invalid Mandatory Field', variable)
...
CustomKeywords.'mii.CreditTransfer.compareResponseMessage'(bodyResponse, 'Invalid Mandatory Field (debitedAccountNumber)')
