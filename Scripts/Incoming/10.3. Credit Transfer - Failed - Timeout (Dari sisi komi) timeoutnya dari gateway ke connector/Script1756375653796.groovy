...
variable.put('RmtInfRmtInf', RmtInfRmtInf)
...
RequestObject request = findTestObject('Incoming/Postman/10.3. Credit Transfer - Failed - Timeout (Dari sisi komi) timeoutnya dari gateway ke connector', 
    variable)
...
CustomKeywords.'mii.AccountInquiryIncoming.comparePrtry'(actualResponse, 'U182')
