...
RequestObject request = findTestObject('Incoming/Postman/12.2. Reverse Credit Transfer - Failed - Original Payment Not Found', 
    variable)
...
CustomKeywords.'mii.AccountInquiryIncoming.comparePrtry'(actualResponse, 'U106')
