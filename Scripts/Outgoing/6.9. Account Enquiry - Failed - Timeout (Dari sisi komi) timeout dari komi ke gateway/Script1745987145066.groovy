...
RequestObject request = findTestObject('Outgoing/6.9. Account Enquiry - Failed - Timeout (Dari sisi komi) timeout dari komi ke gateway', 
    variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '3500')
