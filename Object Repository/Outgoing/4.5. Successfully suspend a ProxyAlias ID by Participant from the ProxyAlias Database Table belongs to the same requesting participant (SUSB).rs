...
<WebServiceRequestEntity>
   ...
   <name>4.5. Successfully suspend a ProxyAlias ID by Participant from the ProxyAlias Database Table belongs to the same requesting participant (SUSB)</name>
   <tag></tag>
   <elementGuidId>978bc1b8-579e-4d46-a235-87e58457a729</elementGuidId>
