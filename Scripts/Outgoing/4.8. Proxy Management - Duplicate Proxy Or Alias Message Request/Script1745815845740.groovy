...
RequestObject request = findTestObject('Outgoing/4.8. Proxy Management - Duplicate Proxy Or Alias Message Request', variable)
...
CustomKeywords.'mii.ProxyManagement.compareResponseCode'(bodyResponse, '3815')
