...
CustomKeywords.'mii.Management_Inquiry.compareResponseCode'(bodyResponse, '3603')

CustomKeywords.'mii.Management_Inquiry.compareResponseMessage'(bodyResponse, 'Transaction Failed, due to Account Not Found')
