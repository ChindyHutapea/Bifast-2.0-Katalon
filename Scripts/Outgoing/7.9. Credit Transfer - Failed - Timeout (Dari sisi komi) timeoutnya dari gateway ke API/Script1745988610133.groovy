...
RequestObject request = findTestObject('Outgoing/7.9. Credit Transfer - Failed - Timeout (Dari sisi komi) timeoutnya dari gateway ke API', variable)
...
CustomKeywords.'mii.CreditTransfer.compareResponseCode'(bodyResponse, '3408')
