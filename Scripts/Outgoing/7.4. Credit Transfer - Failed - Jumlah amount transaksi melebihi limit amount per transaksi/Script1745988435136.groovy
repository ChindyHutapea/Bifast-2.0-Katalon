...
RequestObject request = findTestObject('Outgoing/7.4. Credit Transfer - Failed - Jumlah amount transaksi melebihi limit amount per transaksi', variable)
...
CustomKeywords.'mii.CreditTransfer.compareResponseCode'(bodyResponse, '3232')
