...
RequestObject request = findTestObject('Outgoing/6.8. Account Enquiry - Failed - Timeout (Dari sisi komi) timeoutnya dari gateway ke connector', 
    variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '3408')
