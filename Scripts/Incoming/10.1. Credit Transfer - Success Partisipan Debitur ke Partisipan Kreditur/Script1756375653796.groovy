...
RequestObject request = findTestObject('Incoming/Postman/10.1. Credit Transfer - Success Partisipan Debitur ke Partisipan Kreditur', 
    variable)
...
CustomKeywords.'mii.AccountInquiryIncoming.comparePrtry'(actualResponse, 'U000')
