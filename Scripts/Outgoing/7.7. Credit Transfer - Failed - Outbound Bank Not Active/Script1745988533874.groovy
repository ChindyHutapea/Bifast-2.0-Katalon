...
RequestObject request = findTestObject('Outgoing/7.7. Credit Transfer - Failed - Outbound Bank Not Active', variable)
...
CustomKeywords.'mii.CreditTransfer.compareResponseCode'(bodyResponse, '3128')
