...
RequestObject request = findTestObject('Outgoing/4.5. Successfully suspend a ProxyAlias ID by Participant from the ProxyAlias Database Table belongs to the same requesting participant (SUSB)', 
    variable)
