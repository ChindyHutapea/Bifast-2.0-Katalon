...
RequestObject request = findTestObject('Outgoing/1.3. Send Proxy Alias to get Proxy list - Failed - Data not found (Negative)', variable)
...
CustomKeywords.'mii.proxyList.compareResponseCode'(bodyResponse, '2017')
