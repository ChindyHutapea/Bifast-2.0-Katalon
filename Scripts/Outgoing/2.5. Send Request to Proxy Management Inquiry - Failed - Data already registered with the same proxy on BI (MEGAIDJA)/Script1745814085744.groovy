...
RequestObject request = findTestObject('Outgoing/2.5. Send Request to Proxy Management Inquiry - Failed - Data already registered with the same proxy on BI (MEGAIDJA)', 
    variable)
